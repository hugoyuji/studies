...
public class AlunoController {
    ...
    @PostMapping
    public AlunoResponseDTO cadastrar(@Valid @RequestBody AlunoRequestDTO alunoDTO){
    ...
    @PutMapping("/{id}")
    public AlunoResponseDTO alterar(@PathVariable Long id,@Valid @RequestBody AlunoRequestDTO aluno){
